...
def get_reservation_confirmation(restaurant_id_list,sqs=boto3.client('sqs',region_name=os.getenv("AWS_REGION","us-east-1")),queue_url=os.getenv("SQS_RESERVATION_RESQUESTS_QUEUE_URL")):
    while True:
